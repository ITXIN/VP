...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/../../flutter_module/.ios/Flutter/engine/Flutter.xcframework" "" "true" "ios-arm64_armv7/Flutter.framework" "ios-arm64_x86_64-simulator/Flutter.framework"
fi
